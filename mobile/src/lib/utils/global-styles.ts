...
const lessVariables = (typeof paletteLess === 'string') ? lessToJs(paletteLess, {
...
const GlobalStyles = createGlobalStyle`
  *, *:before, *:after {
  ...
  /* Make small table styling the same as middle/default tables (this matches antd default) */
  .ant-table-small {
    border: 0px;
    border-radius: 0px;
  }
  ...
  {
    /* hack to fix issue with sidebar overlapping table in IE11. *::-ms-backdrop only targets IE11.
     All other browsers consider it invalid CSS and ignore the rest of the rule. */
    *::-ms-backdrop, .ant-layout {
      /* make the content table a bit less wide */
      max-width: 85%;
    }

    *::-ms-backdrop, .ant-layout-sider-has-trigger:not(.ant-layout-sider-collapsed) {
      /* have to use !important because antd applies inline styles */
      flex: none !important;
      min-width: auto !important;
      width: auto !important;
    }

    *::-ms-backdrop, .ant-layout-sider-trigger {
      width: auto !important;
    }
  }
`
